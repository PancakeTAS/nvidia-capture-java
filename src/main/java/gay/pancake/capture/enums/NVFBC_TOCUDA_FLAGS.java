...
interface NVFBC_TOCUDA_FLAGS  {
     ...
     */
    int NVFBC_TOCUDA_GRAB_FLAGS_NOFLAGS = 0;
     ...
     */
    int NVFBC_TOCUDA_GRAB_FLAGS_NOWAIT = 1;
     ...
     */
    int NVFBC_TOCUDA_GRAB_FLAGS_FORCE_REFRESH = (1 << 1);
     ...
     * never seen yet.
     */
    int NVFBC_TOCUDA_GRAB_FLAGS_NOWAIT_IF_NEW_FRAME_READY = (1 << 2);
