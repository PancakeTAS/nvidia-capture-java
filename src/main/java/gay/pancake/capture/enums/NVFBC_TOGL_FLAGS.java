...
interface NVFBC_TOGL_FLAGS  {
     ...
     */
    int NVFBC_TOGL_GRAB_FLAGS_NOFLAGS = 0;
     ...
     */
    int NVFBC_TOGL_GRAB_FLAGS_NOWAIT = 1;
     ...
     */
    int NVFBC_TOGL_GRAB_FLAGS_FORCE_REFRESH = (1 << 1);
     ...
     * never seen yet.
     */
    int NVFBC_TOGL_GRAB_FLAGS_NOWAIT_IF_NEW_FRAME_READY = (1 << 2);
